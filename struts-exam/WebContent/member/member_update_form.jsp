    ...
    <div class="container" style="margin-top: 100px">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form action="./member.do" method="post" id="updateFrm" name="updateFrm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="name" name="name" class="form-control" placeholder="이름" value="${vo.name }">
                        </div>
                    </div>
