				...
				<div class="panel-body">
					...
					<html:form action="board" method="post" styleClass="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<html:text property="writer" styleClass="form-control" value="${vo.writer}" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<html:textarea rows="15" styleId="summernote" property="content" styleClass="form-control" value="${vo.content}">
								</html:textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="submit" value="수정완료" id="returnBtn"
						...
						<html:hidden property="seq" name="seq" value="${vo.seq}" />
